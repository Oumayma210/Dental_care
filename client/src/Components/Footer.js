...
<div id="container">
  <div id="part1">
    <div id="companyinfo">
      ...
      <p id="detail">
        We create awesome code snippets that will help you in creating your own
        beautiful site.{" "}
      </p>
    </div>
    <div id="explore">
  ...
  <div id="part2">
    <p id="txt6">
      <i className="material-icons tiny"> copyright</i>copyright 2019
      BBbootstrap - All right reserved
    </p>
  </div>
</div>
